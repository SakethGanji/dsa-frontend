                                ...
                                <CardContent className="p-3 relative">
                                  <div className="flex items-start gap-3">
                                    <motion.div 
                                      ...
                                      whileTap={{ scale: 0.9 }}
                                      className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg bg-gradient-to-br from-primary to-primary/80 text-primary-foreground"
                                    >
